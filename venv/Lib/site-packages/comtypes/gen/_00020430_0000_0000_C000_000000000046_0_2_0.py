...
__all__ = [ 'Font', 'OLE_XPOS_CONTAINER', 'OLE_COLOR',
           'OLE_YSIZE_PIXELS', 'Unchecked', 'OLE_XSIZE_CONTAINER',
           'OLE_CANCELBOOL', 'Checked', 'FONTITALIC', 'FONTBOLD',
           'IPicture', 'OLE_YPOS_CONTAINER', 'FONTUNDERSCORE',
           'OLE_XPOS_PIXELS', 'OLE_YSIZE_HIMETRIC', 'Picture',
           'OLE_TRISTATE', 'FONTNAME', 'OLE_OPTEXCLUSIVE',
           'OLE_XPOS_HIMETRIC', 'StdPicture', 'StdFont',
           'OLE_YPOS_PIXELS', 'OLE_XSIZE_HIMETRIC', 'Gray',
           'Monochrome', 'Default', 'OLE_XSIZE_PIXELS',
           'LoadPictureConstants', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_YSIZE_CONTAINER', 'VgaColor', 'FONTSTRIKETHROUGH',
           'OLE_YPOS_HIMETRIC', 'OLE_HANDLE', 'IFontEventsDisp',
           'FontEvents', 'IPictureDisp', 'IFontDisp', 'Color',
           'FONTSIZE', 'IFont']
from comtypes import _check_version; _check_version('', 1622894692.653069)
